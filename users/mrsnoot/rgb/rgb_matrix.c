...
uint8_t num_block[] = { 34, 37, 38, 39, 42, 43, 44, 47, 48, 49 };
uint8_t num_block_ops[] = { 41, 45, 46, 50 };
uint8_t num_block_dots[] = { 36, 40 };
// Symbol
uint8_t symbols[] = { 18, 19, 20, 21, 22, 23, 49, 50 };
uint8_t brackets[] = { 9, 10, 11, 12, 14, 15, 16, 17 };
uint8_t xml_pretty_print[] = { 47, 48 };
uint8_t im1_admin[] = { 37, 38 };
uint8_t hl7_entities[] = { 42, 43, 44 };
uint8_t print_screen = 52;
uint8_t trackball_scroll_hor = 45;
// Adjust
uint8_t reset_kb_tb[] = { 24, 25, 26 };
uint8_t rgb_toggle = 23;
uint8_t audio_settings[] = { 14, 15, 16, 17, 18 };
uint8_t auto_shift_settings[] = { 10, 11, 12, 13 };
uint8_t tb_dpi[] = { 36, 41 };
uint8_t window_switch[] = { 37, 38, 39, 42, 43, 44, 47, 48, 49 };
uint8_t opy_indicator = 51;
uint8_t qwerty_indicator = 52;
uint8_t host_led_status[] = { 40, 45, 50 };
#endif
...
uint8_t num_block[] = { 45, 46, 47, 51, 52, 53, 57, 58, 59, 64 };
uint8_t num_block_ops[] = { 44, 48, 50, 54 };
uint8_t num_block_dots[] = { 56, 60 };
// Symbol
uint8_t symbols[] = { 6, 7, 8, 9, 10, 16, 47, 48 };
uint8_t brackets[] = { 12, 13, 14, 15, 18, 19, 20, 21 };
uint8_t xml_pretty_print[] = { 45, 46 };
uint8_t im1_admin[] = { 57, 58 };
uint8_t hl7_entities[] = { 51, 52, 53 };
uint8_t print_screen = 55;     
uint8_t trackball_scroll_hor = 54;
// Adjust
uint8_t reset_kb_tb[] = { 11, 17, 23 };
uint8_t rgb_toggle = 10;
uint8_t audio_settings[] = { 12, 13, 14, 15, 16 };
uint8_t auto_shift_settings[] = { 19, 20, 21, 22 };
uint8_t tb_dpi[] = { 50, 56 };
uint8_t window_switch[] = { 45, 46, 47, 51, 52, 53, 57, 58, 59 };
uint8_t opy_indicator = 49;
uint8_t qwerty_indicator = 55;
uint8_t host_led_status[] = { 48, 54, 60 };
#endif
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
	...
	switch (layer)
	{
        ...
        case SYMBOL:
            ...
            set_color(trackball_scroll_hor, GREEN);
        ...
        case ADJUST:
            ...
            set_colors_orange(window_switch, sizeof(window_switch));
            set_color(opy_indicator, LILAC);
            set_color(qwerty_indicator, ICEBLUE);
