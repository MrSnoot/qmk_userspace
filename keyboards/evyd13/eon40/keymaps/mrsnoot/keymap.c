...
[OPY] = LAYOUT_planck_mit(
    ...
    KC_BTN1, TB_SCR , XXXXXXX, XXXXXXX, THUMB_1, THUMB_2,          THUMB_4, CS_VDPR, CS_VDNX, CS_TSPR, CS_TSNX
),
...
[NAV] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______, _______,          MO_ADJ,  _______, _______, _______, _______
),

[NUM_FUNC] = LAYOUT_planck_mit(
    ...
    _______, _______, CS_PGU, CS_PGD,  _______, _______,          DE_0,    _______, _______, _______, _______
),
...
[SYMBOL] = LAYOUT_planck_mit(
    ...
    MS_BN13, KC_BTN3, XXXXXXX, XXXXXXX, MO_ADJ,  _______,          _______, _______, _______, _______, _______
),

[ADJUST] = LAYOUT_planck_mit(
    QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGUI(KC_7), RGUI(KC_8), RGUI(KC_9), KC_NUM,  DF(OPY),
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TB_DPI , RGUI(KC_4), RGUI(KC_5), RGUI(KC_6), KC_CAPS, DF(QWERTY),
