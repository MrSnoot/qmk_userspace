...
[OPY] = LAYOUT_planck_mit(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, NUM_FUN, NAV_SPC, XXXXXXX,          NAV_ENT, OSL_SYM, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[NAV] = LAYOUT_planck_mit(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN1, KC_BTN2, TB_SCR , XXXXXXX,
...
[NUM_FUNC] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______, _______,          DE_0   , MO_ADJ, _______, _______, _______
),
...
[SYMBOL] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, MO_ADJ , _______, _______,          _______, _______, _______, _______, _______
),
