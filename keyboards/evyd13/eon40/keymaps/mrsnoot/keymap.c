...
#define LAYOUT_wrapper(...)            LAYOUT_ortho_4x12_2x2u(__VA_ARGS__)
#define LAYOUT_eon40_base( \
  ...
  LAYOUT_wrapper( \
  K01    , K02    , K03    , K04    , K05    , XXXXXXX, XXXXXXX, K06    , K07    , K08    , K09    , K0A, \
  K11    , K12    , K13    , K14    , K15    , XXXXXXX, XXXXXXX, K16    , K17    , K18    , K19    , K1A, \
  K21    , K22    , K23    , K24    , K25    , XXXXXXX, XXXXXXX, K26    , K27    , K28    , K29    , K2A, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, K31    ,                   K32    , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX \
  )
/* Re-pass though to allow templates to be used */
#define LAYOUT_base_wrapper(...)       LAYOUT_eon40_base(__VA_ARGS__)
