...
[OPY] = LAYOUT_ortho_4x12_2x2u(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, OSL_NUM, NAV_SPC,                   NAV_ENT, OSL_SYM, XXXXXXX, XXXXXXX, XXXXXXX
),

[NAV] = LAYOUT_ortho_4x12_2x2u(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_UP  , KC_END , KC_PGUP,
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, TB_SCR,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN1, KC_BTN2, KC_LCTL, KC_LSFT,
...
[NUM_FUNC] = LAYOUT_ortho_4x12_2x2u(
    ...
    _______, _______, _______, _______, _______,                   DE_0   , MO_ADJ, _______, _______, _______
),
...
[SYMBOL] = LAYOUT_ortho_4x12_2x2u(
    ...
    XXXXXXX, DE_LBRC, DE_RBRC, DE_LABK, DE_RABK, XXXXXXX, XXXXXXX, XXXXXXX, F2_CPLN, IM1_INS, XXXXXXX, XXXXXXX,
    _______, _______, _______, MO_ADJ , _______,                   _______, _______, _______, _______, _______
),
