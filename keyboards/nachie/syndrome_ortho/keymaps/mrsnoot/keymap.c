...
[SONNE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, NUM_SPC, XXXXXXX, XXXXXXX, NUM_ENT, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[MOUSE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    _______, _______, _______, _______, KC_LGUI, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______
),
...
[SYMBOL] = LAYOUT(
    ...
    _______, _______, _______, _______, MO_ADJ , XXXXXXX, XXXXXXX, _______, _______, _______, _______
),
