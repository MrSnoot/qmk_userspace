...
[OPY] = LAYOUT(
    ...
    KC_BTN2, DE_J   , DE_ODIA, DE_ADIA, DE_U   , DE_UDIA, CS_VDPR, CS_VDNX, DE_B   , DE_D   , DE_L   , DE_F   , DE_SS  , V_DESKT,
...
[QWERTY] = LAYOUT(
    ...
    _______, DE_Y   , DE_X   , DE_C   , DE_V   , DE_B   , _______, _______, DE_N   , DE_M   , DE_COMM, DE_DOT , DE_MINS, _______,
...
[NUM_FUNC] = LAYOUT(
    ...
    XXXXXXX, KC_F11 , KC_F12, XXXXXXX, S_LN_F5, XXXXXXX, _______, _______, DE_COMM, DE_1 , DE_2   , DE_3   , DE_DOT , XXXXXXX,
...
[SYMBOL] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, DE_RCBR, DE_RBRC, DE_RPRN, DE_RABK, _______, _______, XXXXXXX, F2_CPLN, IM1_INS, XXXXXXX, XXXXXXX, XXXXXXX,
...
[ADJUST] = LAYOUT(
    ...
    TB_RST , AS_TOGG, AS_DOWN, AS_UP  , AS_RPT , XXXXXXX, _______, _______, XXXXXXX, RGUI(KC_1), RGUI(KC_2), RGUI(KC_3), KC_SCRL, XXXXXXX   ,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______   , _______   , _______   , _______, _______
)
};